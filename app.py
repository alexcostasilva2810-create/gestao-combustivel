...
# --- BLOCO 3: TELA DE LOGIN FLUTUANTE ---
...
if st.session_state.tela == 'registro':
    ...
    with st.form("form_reg"):
        ...
        st.markdown('<p class="texto-verde">📷 Foto Relógio Bomba</p>', unsafe_allow_html=True)
        st.file_uploader("FOTO ANTES", type=['jpg','png'])
        st.file_uploader("FOTO DEPOIS", type=['jpg','png'])
